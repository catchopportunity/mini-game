...
// 부동산을 다 팔아 담보가 없어도 최소한의 신용대출(MIN_DEBT_CAP)은 가능. 출발점을 통과할 때마다 미상환
// 부채에 이자가 붙음. "플레이어 보정(순자산 계산)"에서는 부채를 순자산에서 뺀다 — 빚이 있을수록 순자산이
// 낮게 잡혀서 상대와의 격차가 더 크게 보이고, 그만큼 은근한 난이도 보정(유리한 카드/주사위)이 더 잘 켜짐.
const DEBT_INTEREST_RATE = 0.15;
const MAX_DEBT_RATIO = 1.0;
const MIN_DEBT_CAP = 1000;
