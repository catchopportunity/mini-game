...
const sharedGlobals = {
  ...
  botWantsToAcquire: 'readonly',
  // js/engine.js
  players: 'writable', pot: 'writable', current: 'writable', phase: 'writable',
  interrupted: 'writable', pendingCharge: 'writable', botCount: 'writable',
  ...
  playCasino: 'readonly', chargedDie: 'readonly', rollForCurrent: 'readonly',
