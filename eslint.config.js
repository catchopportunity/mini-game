...
const sharedGlobals = {
  ...
  AUCTION_BID_MIN_RATE: 'readonly', AUCTION_BID_MAX_RATE: 'readonly', AUCTION_BANK_RATE: 'readonly',
  DEBT_INTEREST_RATE: 'readonly', MAX_DEBT_RATIO: 'readonly', MIN_DEBT_CAP: 'readonly',
  GLOBAL_EVENT_TRIGGER_CHANCE: 'readonly', GLOBAL_EVENT_DURATION_TURNS: 'readonly',
  GLOBAL_EVENTS: 'readonly', BOT_PERSONALITIES: 'readonly',
  // js/audio.js
